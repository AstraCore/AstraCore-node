...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `astracore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ astracore-node add wallet-service');
      console.log('    $ astracore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ astracore-node remove wallet-service');
      console.log('    $ astracore-node remove insight-api');
      console.log();
    });
